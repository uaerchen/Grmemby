...
internal object DownloadNotificationContract {
    ...
    const val ACTION_PAUSE = "com.grmemby.app.download.PAUSE"
    const val ACTION_RESUME = "com.grmemby.app.download.RESUME"
    const val ACTION_CANCEL = "com.grmemby.app.download.CANCEL"

...
class DownloadForegroundService : Service() {
    ...
    private fun fallbackNotification(): Notification {
        return Notification.Builder(this, DownloadNotificationContract.CHANNEL_ID)
            .setSmallIcon(com.grmemby.app.R.mipmap.ic_launcher)
    ...
    companion object {
        private const val ACTION_START = "com.grmemby.app.download.FGS_START"
        private const val ACTION_STOP = "com.grmemby.app.download.FGS_STOP"

...
class PlayerViewModel @Inject constructor(
    ...
    fun initializePlayer(
        ...
        viewModelScope.launch {
            try {
                ...
                val playerPreferences = com.grmemby.player.preferences.PlayerPreferences(context)
    ...
    private fun playbackTrackSelection(
        ...
        com.grmemby.player.preferences.PlayerPreferences(context).apply {
     ...
     */
    fun seekBackward() {
        val seconds = com.grmemby.player.preferences.PlayerPreferences(playerContext ?: return)

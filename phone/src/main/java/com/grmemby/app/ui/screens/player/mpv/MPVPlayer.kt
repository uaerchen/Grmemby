...
import com.grmemby.player.core.PlayerTrackState
    ...
    fun trackState(
        ...
        val audioTracks = audioStreams.mapNotNull { stream ->
            ...
            AudioTrackInfo(
                ...
                label = stream.displayTitle ?: stream.title ?: stream.language ?: "音轨 $streamIndex",
        ...
        val subtitleTracks = listOf(
            ...
            SubtitleTrackInfo(
                ...
                label = stream.displayTitle ?: stream.title ?: stream.language ?: "字幕 $streamIndex",
                language = stream.language,

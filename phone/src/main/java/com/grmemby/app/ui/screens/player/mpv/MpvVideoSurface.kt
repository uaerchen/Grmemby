...
import com.grmemby.app.ui.screens.player.GestureHelper
...
fun MpvVideoSurface(
    ...
    onPlaybackSpeedBoostChange: (Boolean) -> Unit,
    ...
    AndroidView(
        factory = { context ->
            TextureView(context).apply {
                ...
                val gestureHelper = GestureHelper(
                    ...
                    onPlaybackSpeedBoostChange = onPlaybackSpeedBoostChange,
        ...
        update = {
            ...
            if (lifecycle == Lifecycle.Event.ON_PAUSE && !isInPictureInPictureMode) {
                player.pause()
            }
        },
        modifier = modifier

package com.grmemby.data.preferences
...
class NetworkPreferences(context: Context) {
    ...
    fun isBlockIpv6ConnectionsEnabled(): Boolean {
        return prefs.getBoolean(KEY_BLOCK_IPV6_CONNECTIONS, DEFAULT_BLOCK_IPV6_CONNECTIONS)
    }

    fun setBlockIpv6ConnectionsEnabled(enabled: Boolean) {
        prefs.edit().putBoolean(KEY_BLOCK_IPV6_CONNECTIONS, enabled).apply()
    }
    ...
    companion object {
        ...
        const val DEFAULT_BLOCK_IPV6_CONNECTIONS = false

        private const val PREFS_NAME = "grmemby_network_prefs"
        ...
        private const val KEY_BLOCK_IPV6_CONNECTIONS = "block_ipv6_connections"
    }
}

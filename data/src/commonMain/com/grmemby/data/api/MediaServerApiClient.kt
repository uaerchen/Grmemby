...
import com.grmemby.data.network.ApiHeaders
...
internal class MediaServerApiClient(
    ...
    override suspend fun getItemsCounts(userId: String?): ApiResponse<ItemCountsDto> = get(
    ...
    override suspend fun updateUserItemData(
        userId: String,
        itemId: String,
        request: UpdateUserItemDataRequest
    ): ApiResponse<Unit> = post(
        endpoint = "Users/$userId/Items/$itemId/UserData",
        requestBody = request
    )
